        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-plus-circle-fill me-2 text-primary"></i>Form Tambah Keunggulan
                </h5>
            </div>
                ...
                <form action="{{ route('feature.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('icon', 'bi-grid-3x3-gap-fill') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="deskripsi"
                                  ...
                                  rows="4"
                                  placeholder="Tuliskan keterangan detail keunggulan kami...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-1"></i> Simpan Keunggulan
                        </button>
                    </div>
