                ...
                <form action="{{ route('about.update', $about->id) }}" method="POST">
                    ...
                    <div class="border-bottom pb-3 mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="judul_profil" name="judul_profil" class="form-control @error('judul_profil') is-invalid @enderror" value="{{ old('judul_profil', $about->judul_profil) }}" placeholder="Contoh: Dedikasi Terhadap Keindahan & Sirkulasi Udara Alami">
                            @error('judul_profil')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="deskripsi_profil_1" name="deskripsi_profil_1" rows="3" class="form-control @error('deskripsi_profil_1') is-invalid @enderror" placeholder="Paragraf pertama untuk deskripsi profil perusahaan">{{ old('deskripsi_profil_1', $about->deskripsi_profil_1) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="deskripsi_profil_2" name="deskripsi_profil_2" rows="3" class="form-control @error('deskripsi_profil_2') is-invalid @enderror" placeholder="Paragraf kedua untuk deskripsi profil perusahaan (opsional)">{{ old('deskripsi_profil_2', $about->deskripsi_profil_2) }}</textarea>
