        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Nomor Admin
                </h5>
            </div>
            <div class="card-body pt-4">
                ...
                {{-- Gunakan $nomoradmin (model) bukan ->id agar route binding tidak null --}}
                <form action="{{ route('nomoradmin.update', $nomoradmin) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nama_admin', $nomoradmin->nama_admin) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('no_wa', $nomoradmin->no_wa) }}"
                        ...
                        <div class="form-text text-muted mt-1">
                            ...
                            Klik <strong>Test WA</strong> untuk memastikan nomor terdaftar di WhatsApp sebelum disimpan.
                        </div>
...
(function () {
    ...
    function updateTestLink() {
        ...
        if (phone.length >= 10) {
            btnTestWa.href = 'https://wa.me/' + phone;
    ...
    updateTestLink(); // aktif langsung saat halaman dibuka
})();
</script>
@endpush
